...
if choice == 'A':
    ...
    print("A. Take the steep path")
    print("B. Take the safe path ")
    c5 = input("Enter you choice: ")
    if c5 =='A':
        print("You discover an eagle's nest.")
        print("A. Check the nest ")
        print("B. Move on")
